...
one sig Root_S2_S21 extends Root_S2 {} 
one sig Root_S2_S22 extends Root_S2 {} 

abstract sig Transitions {}
one sig NO_TRANS extends Transitions {} 
one sig Root_S2_S22_t8 extends Transitions {} 
one sig Root_S1_S11_t1 extends Transitions {} 
one sig Root_S2_S21_t6 extends Transitions {} 
one sig Root_S2_S22_t7 extends Transitions {} 
one sig Root_S1_S11_t2 extends Transitions {} 
one sig Root_S1_S12_t3 extends Transitions {} 
one sig Root_S2_S21_t5 extends Transitions {} 
one sig Root_S1_S12_t4 extends Transitions {} 
...
pred dsh_initial [
	s: one DshSnapshot] {
  ((s.dsh_conf0) = Root_S1_S11) && ((s.dsh_taken0) = NO_TRANS)
}

pred Root_S2_S22_t8_pre [
	s: one DshSnapshot] {
  some (Root_S2_S22 & (s.dsh_conf0))
}


pred Root_S2_S22_t8_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) -
      (((Root_S1_S11 + Root_S1_S12) + Root_S2_S21) +
         Root_S2_S22)) + Root_S1_S11)
  (sn.dsh_taken0) = Root_S2_S22_t8
}

pred Root_S2_S22_t8 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S2_S22_t8_pre
  sn.(s.Root_S2_S22_t8_post)
}
...
pred Root_S2_S21_t6_pre [
	s: one DshSnapshot] {
  some (Root_S2_S21 & (s.dsh_conf0))
}


pred Root_S2_S21_t6_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) -
      (((Root_S1_S11 + Root_S1_S12) + Root_S2_S21) +
         Root_S2_S22)) + Root_S1_S12)
  (sn.dsh_taken0) = Root_S2_S21_t6
}

pred Root_S2_S21_t6 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S2_S21_t6_pre
  sn.(s.Root_S2_S21_t6_post)
}

pred Root_S2_S22_t7_pre [
	s: one DshSnapshot] {
  some (Root_S2_S22 & (s.dsh_conf0))
}


pred Root_S2_S22_t7_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) - (Root_S2_S21 + Root_S2_S22)) +
     Root_S2_S21)
  (sn.dsh_taken0) = Root_S2_S22_t7
}

pred Root_S2_S22_t7 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S2_S22_t7_pre
  sn.(s.Root_S2_S22_t7_post)
}

pred Root_S1_S11_t2_pre [
	s: one DshSnapshot] {
  some (Root_S1_S11 & (s.dsh_conf0))
}


pred Root_S1_S11_t2_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) -
      (((Root_S1_S11 + Root_S1_S12) + Root_S2_S21) +
         Root_S2_S22)) + Root_S2_S21)
  (sn.dsh_taken0) = Root_S1_S11_t2
}

pred Root_S1_S11_t2 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S1_S11_t2_pre
  sn.(s.Root_S1_S11_t2_post)
}
...
pred Root_S2_S21_t5_pre [
	s: one DshSnapshot] {
  some (Root_S2_S21 & (s.dsh_conf0))
}


pred Root_S2_S21_t5_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) - (Root_S2_S21 + Root_S2_S22)) +
     Root_S2_S22)
  (sn.dsh_taken0) = Root_S2_S21_t5
}

pred Root_S2_S21_t5 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S2_S21_t5_pre
  sn.(s.Root_S2_S21_t5_post)
}

pred Root_S1_S12_t4_pre [
	s: one DshSnapshot] {
  some (Root_S1_S12 & (s.dsh_conf0))
}


pred Root_S1_S12_t4_post [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  (sn.dsh_conf0) =
  (((s.dsh_conf0) -
      (((Root_S1_S11 + Root_S1_S12) + Root_S2_S21) +
         Root_S2_S22)) + Root_S2_S22)
  (sn.dsh_taken0) = Root_S1_S12_t4
}

pred Root_S1_S12_t4 [
	s: one DshSnapshot,
	sn: one DshSnapshot] {
  s.Root_S1_S12_t4_pre
  sn.(s.Root_S1_S12_t4_post)
}
...
pred dsh_enough_operations {
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S2_S22_t8))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S1_S11_t1))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S2_S21_t6))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S2_S22_t7))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S1_S11_t2))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S1_S12_t3))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S2_S21_t5))
  (some s: one
  DshSnapshot,sn: one
  DshSnapshot | sn.(s.Root_S1_S12_t4))
}
