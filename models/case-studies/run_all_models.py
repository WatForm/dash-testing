...
# ./run_all_models -t tcmc (or another m/c method) <dir_name>
...
# NAD: in my environment
exe='java -ea -cp /Users/nday/UW/github/org.alloytools.alloy/org.alloytools.alloy.dist/target/org.alloytools.alloy.dist.jar ca.uwaterloo.watform.dash4whole.Dash'
...
parser.add_argument('sources', nargs='*',
                    type=pathlib.Path,
                    # TODO: make this just read all directories except combined-file
                    default=['2019-dash-website','2022-bandali-thesis', '2022-tamjid-thesis', '2023-bandali-day-paper']
                    )
